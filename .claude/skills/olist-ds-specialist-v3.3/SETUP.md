# Setup — Olist DS Specialist Skill v3.3
...
Você verá a pasta `olist-ds-specialist-v3.3/` com todos os arquivos.
...
```bash
cat .claude/skills/olist-ds-specialist-v3.3/figma-config.json
```
...
```bash
# Skill instalada?
ls .claude/skills/olist-ds-specialist-v3.3/SKILL.md

# Config com libraryKeys?
grep "lk-" .claude/skills/olist-ds-specialist-v3.3/figma-config.json | head -3
```
...
```
Use $olist-ds-specialist-v3.3 para criar a tela de upgrade de planos no Figma
```
...
3. Selecionar pasta `olist-ds-specialist-v3.3/`
4. Ativar a skill
