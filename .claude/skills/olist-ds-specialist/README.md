# Olist Design System — Especialista (v3.19 · atualizado em 2026-09-02)
...
> **Raiz:** 6 arquivo(s) · **Decisions:** 13 arquivo(s) · **Referências:** 17 arquivo(s) · **Total:** 36 arquivo(s) — atualizado em 2026-09-02 pelo `sync-skill-meta.mjs`
