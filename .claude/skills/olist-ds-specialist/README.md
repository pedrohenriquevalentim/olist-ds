# Olist Design System — Especialista (v3.15 · atualizado em 2026-08-18)
...
> **Raiz:** 6 arquivo(s) · **Decisions:** 13 arquivo(s) · **Referências:** 16 arquivo(s) · **Total:** 35 arquivo(s) — atualizado em 2026-08-18 pelo `sync-skill-meta.mjs`
