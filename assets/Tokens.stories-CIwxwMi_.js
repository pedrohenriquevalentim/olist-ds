  ...
  render: () => <div style={{
    ...
    maxWidth: 1100
      ...
      marginBottom: 48
        ...
        sem: '(direto)',
        prim: '--font-size-x15-12px → --font-size-12px',
        hex: '12px'
      }, {
