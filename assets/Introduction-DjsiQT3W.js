...
|---|---|---|
| `,(0,c.jsx)(n.code,{children:`Button`}),` | Action | Botão com variantes primary, secondary e tertiary |
| `,(0,c.jsx)(n.code,{children:`Checkbox`}),` | Input | Caixa de seleção com rótulo e estado de erro |
| `,(0,c.jsx)(n.code,{children:`Chip`}),` | Input / Filter | Tag interativa para filtros e seleção múltipla |
| `,(0,c.jsx)(n.code,{children:`Icon`}),` | Brand | Ícones do design system (rebrand 24px) |
| `,(0,c.jsx)(n.code,{children:`InputSelect`}),` | Input | Campo de seleção com suporte a busca e múltipla seleção |
| `,(0,c.jsx)(n.code,{children:`Logo`}),` | Brand | Logotipo Olist em variantes de cor e tamanho |
| `,(0,c.jsx)(n.code,{children:`ProdutosOlistIcons`}),` | Brand | Ícones dos 8 produtos Olist com estados e temas |`]}),`
