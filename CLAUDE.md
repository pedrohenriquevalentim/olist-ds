...
2. Leia `.claude/skills/olist-ds-specialist-v3.3/references/VISAO_GERAL.md` (sempre primeiro)
3. Leia `.claude/skills/olist-ds-specialist-v3.3/figma-config.json` ANTES de qualquer operação com Figma MCP
