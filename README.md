...
│   │   ├── variables.css
│   │   └── tokens.js
│   ├── components/                      # <!-- AUTO:component-count -->12<!-- /AUTO:component-count --> componentes
│   │   └── [ComponentName]/
│   │       ├── ComponentName.tsx
...
Button, Checkbox, Chip, Icon, InputPassword, InputSearch, InputSelect, InputText, Logo, MenuGlobal, ProdutosOlistIcons, Toggle
...
A skill `olist-ds-specialist` (<!-- AUTO:skill-version-start -->v3.15<!-- AUTO:skill-version-end -->) permite que qualquer pessoa da empresa crie telas a partir de SDDs, implemente componentes React do DS e gere documentação no Figma — com precisão consistente.
